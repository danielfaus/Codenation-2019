...
from config.py import url_post, url_request, token
# importing libraries
...
answer.write(json.dumps(request_get, indent=2))     # writing in file
...
key_value = request_dict.get(['numero_casas', default])  # get key
decrypted = ''  # it's get the descrypted message
...
print(req_post.status)
print(json.loads(req_post.data))
